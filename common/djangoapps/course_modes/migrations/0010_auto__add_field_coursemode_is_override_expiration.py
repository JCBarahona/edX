...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseMode.is_override_expiration'
        db.add_column('course_modes_coursemode', 'is_override_expiration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseMode.is_override_expiration'
        db.delete_column('course_modes_coursemode', 'is_override_expiration')
    ...
    models = {
        ...
        'course_modes.coursemode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_override_expiration': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'course_modes.coursemodeautoexpirationconfiguration': {
            'Meta': {'ordering': "('-change_date',)", 'object_name': 'CourseModeAutoExpirationConfiguration'},
            '_verification_window': ('django.db.models.fields.BigIntegerField', [], {'default': '864000000000'}),
