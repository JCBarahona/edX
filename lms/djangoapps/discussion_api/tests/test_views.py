...
class ThreadViewSetPartialUpdateTest(DiscussionAPIViewTestMixin, ModuleStoreTestCase):
    ...
    def register_thread(self, closed=False):
        """
    ...
    def test_closed_thread(self, field, value):
        ...
        self.assertEqual(
            response_data,
            self.expected_response_data(abuse_flagged=value, closed=True, editable_fields=["abuse_flagged"])
        )
...
class CommentViewSetPartialUpdateTest(DiscussionAPIViewTestMixin, ModuleStoreTestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            response_data,
            self.expected_response_data(body="Edited body", editable_fields=["abuse_flagged", "raw_body", "voted"])
        )
        self.assertEqual(
            httpretty.last_request().parsed_body,
            {
    ...
    def test_closed_thread(self, field, value):
        ...
        self.assertEqual(
            response_data,
            self.expected_response_data(abuse_flagged=value, editable_fields=["abuse_flagged"])
        )
